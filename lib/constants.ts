...
export const ROLE_CONFIG: Record<UserRole, { label: string; homeRoute: string; color: string; bg: string }> = {
  ...
  servicio:  { label: 'Servicio',   homeRoute: '/salon',    color: 'text-[#A7B897]', bg: 'bg-[#A7B897]/15 border-[#A7B897]/30' },
  caja:      { label: 'Caja',       homeRoute: '/salon',    color: 'text-[#8BA0BE]', bg: 'bg-[#8BA0BE]/15 border-[#8BA0BE]/30' },
  ...
  salon:     { label: 'Salón',      homeRoute: '/salon',    color: 'text-[#A7B897]', bg: 'bg-[#A7B897]/15 border-[#A7B897]/30' },
